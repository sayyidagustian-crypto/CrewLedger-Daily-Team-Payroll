...
const translations = {
  en: {
    ...
    aboutIntro: 'This application was created to simplify the recording and calculation of piece-rate wages with an equal-sharing system.',
    aboutThanks: "Infinite thanks to <strong>ALLAH SWT</strong> for His blessings and guidance in completing this application.<br/><br/>Jazakallah Khairan to <strong>Google</strong> and the entire <strong>AI Studio</strong> team for providing the incredible platform (<a href='https://aistudio.google.com' target='_blank' rel='noopener noreferrer' class='text-indigo-600 hover:underline'>aistudio.google.com</a>) that made the development of this application possible.<br/><br/>This application is presented by <strong>SAT18 Official</strong>.<br/><br/>We also extend our deepest gratitude to all <strong>visitors</strong> and users. Your feedback is invaluable.",
    aboutBugReportPrompt: 'To provide suggestions or report bugs, please do so via the project page. Your contribution is highly appreciated for learning and improvement.',
    aboutBugReportLink: 'Report an Issue or Suggestion',
    aboutOfficialSite: 'Official Website',
    ...
    enterCode: 'Enter your one-time access code',
    verify: 'Verify',
    ...
    devSettingsSaved: 'Developer settings saved.',
    devSettingsInfo: 'These settings override remote config and are stored locally. Use for testing purposes.',
  ...
  id: {
    ...
    aboutIntro: 'Aplikasi ini dibuat untuk menyederhanakan pencatatan dan penghitungan upah borongan dengan sistem bagi rata.',
    aboutThanks: "Puji syukur kehadirat <strong>ALLAH SWT</strong> atas rahmat dan karunia-Nya sehingga aplikasi ini dapat terselesaikan.<br/><br/>Jazakallah Khairan kami ucapkan kepada <strong>Google</strong> dan seluruh tim <strong>AI Studio</strong> yang telah menyediakan platform luar biasa (<a href='https://aistudio.google.com' target='_blank' rel='noopener noreferrer' class='text-indigo-600 hover:underline'>aistudio.google.com</a>) yang memungkinkan pengembangan aplikasi ini.<br/><br/>Aplikasi ini dipersembahkan oleh <strong>SAT18 Official</strong>.<br/><br/>Kami juga sangat berterima kasih kepada seluruh <strong>pengunjung</strong> dan pengguna. Umpan balik dari Anda sangat berharga.",
    aboutBugReportPrompt: 'Untuk memberikan saran atau melaporkan bug, silakan sampaikan melalui halaman proyek. Kontribusi Anda sangat berarti untuk pembelajaran dan perbaikan.',
    aboutBugReportLink: 'Laporkan Isu atau Saran',
    aboutOfficialSite: 'Situs Resmi',
    ...
    devSettings: 'Pengaturan Pengembang',
    oneTimeCode: 'Kode Sekali Pakai',
    enterCode: 'Masukkan kode akses sekali pakai Anda',
    verify: 'Verifikasi',
    codeVerified: 'Kode Terverifikasi',
    invalidCode: 'Kode tidak valid atau kedaluwarsa',
    admobBannerId: 'ID Banner AdMob',
    adsenseClientId: 'ID Klien AdSense',
    saveDevSettings: 'Simpan Pengaturan Dev',
    devSettingsSaved: 'Pengaturan pengembang disimpan.',
    devSettingsInfo: 'Pengaturan ini menimpa konfigurasi remote dan disimpan secara lokal. Gunakan untuk tujuan pengujian.',
