...
const translations = {
  en: {
    ...
    noPreviousLogsFound: "No recent logs found from the previous month for this employee.",
    ...
    aboutBugReportPrompt: 'To provide suggestions or report bugs, please email us at:',
  ...
  id: {
    ...
    noPreviousLogsFound: "Tidak ada catatan terbaru dari bulan sebelumnya untuk karyawan ini.",
    ...
    aboutBugReportPrompt: 'Untuk memberikan saran atau melaporkan bug, silakan kirimkan email ke:',
